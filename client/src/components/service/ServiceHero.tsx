...
export default function ServiceHero({ serviceId }: ServiceHeroProps) {
  ...
  const getServiceDescription = () => {
    switch (serviceId) {
      ...
      case 'commercial-extract':
        return 'خدمة إلكترونية تتيح للمستفيدين الحصول على مستخرج رسمي لبيانات السجل التجاري أو إفادة تجارية معتمدة لتقديمها للجهات المعنية.';
      case 'issue-license':
        return 'خدمة إلكترونية تمكن المستثمرين من إصدار التراخيص التجارية اللازمة لمزاولة الأنشطة الاقتصادية المختلفة بشكل فوري وميسر.';
      case 'register-trademark':
        return 'خدمة إلكترونية تتيح للمستفيدين تسجيل العلامات التجارية لحمايتها قانونياً وضمان حقوق الملكية الفكرية للمنشأة.';
      case 'renew-license':
        return 'خدمة إلكترونية تتيح لأصحاب الأعمال تجديد الرخص التجارية المنتهية لضمان استمرارية العمل وتجنب المخالفات النظامية.';
      case 'new-cr':
      default:
