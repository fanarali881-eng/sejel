          ...
          <div className="flex justify-center overflow-x-auto">
            <div className="relative" ref={nationalIdRef} style={{width: '600px', maxWidth: '100%'}}>
              ...
              {(photoNoBg || photoPreview) && (
                <div className={`absolute top-[24%] ${isMobile ? 'right-[70%]' : 'left-[5%]'} w-[24%] h-[50%] overflow-hidden`}>
                  <img 
        ...
        <div className={`mb-8 ${showPassport ? '' : 'hidden'}`}>
          ...
          <div className="flex justify-center">
                ...
                <span className="absolute top-[46%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '6px' : '9px', left: isMobile ? '48%' : '50%'}}>تاريخ الميلاد</span>
                  ...
                  <span className="absolute top-[38%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '6px' : '9px', left: isMobile ? '48%' : '50%'}}>Sex/الجنس</span>
                  ...
                  <span className="absolute top-[58%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '6px' : '9px', left: isMobile ? '48%' : '50%'}}>
                    {(() => {
                      const today = new Date();
                  ...
                  <span className="absolute top-[66%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '6px' : '9px', left: isMobile ? '48%' : '50%'}}>
                    {(() => {
                      const today = new Date();
