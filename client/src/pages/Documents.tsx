            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                <span className="absolute top-[46%] left-[48%] text-[#0D5C3D] text-xs" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr'}}>تاريخ الميلاد</span>
                  ...
                  {(photoNoBg || photoPreview) && (
                    <div className="absolute top-[38%] right-[14%] w-[7%] h-[18%] overflow-hidden" style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                      <img 
                        src={photoNoBg || photoPreview} 
                        alt="" 
                  ...
                  <span className="absolute top-[71%] right-[14%] text-black text-xs font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr'}}>
