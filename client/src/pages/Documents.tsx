            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                <div className="relative">
                  ...
                  <span className="absolute top-[8%] right-[15%] text-[#0D5C3D] text-base" style={{fontFamily: 'Lateef, serif', fontWeight: 400, letterSpacing: '1px'}}>المملكة العربية السعودية</span>
                </div>
              </div>
            </div>
          </div>
