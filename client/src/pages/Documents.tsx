        ...
        <div className="mb-8">
          ...
          <div className="flex justify-center">
            <div className="relative" style={{width: '600px', maxWidth: '100%'}}>
              ...
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '28%', right: '12%', width: '35%', textAlign: 'left', direction: 'ltr'}}>
                {arabicFirstName && arabicSecondName && arabicThirdName && arabicFourthName 
                  ? `${arabicFirstName} ${arabicSecondName} ${arabicThirdName} ${arabicFourthName}` 
                  : ''}
              </div>
              ...
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '35%', right: '12%', width: '35%', textAlign: 'left', direction: 'ltr'}}>
              ...
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '56%', right: '12%', width: '18%', textAlign: 'left', direction: 'ltr'}}>
                {vehicleRegistrationType || ''}
              </div>
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '56%', left: '8%', width: '18%', textAlign: 'left', direction: 'ltr'}}>
                {vehicleModel || vehicleModelCustom || ''}
              </div>
              
              {/* Row 6: ماركة المركبة (يمين) | وزن المركبة (يسار) */}
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '63%', right: '12%', width: '18%', textAlign: 'left', direction: 'ltr'}}>
                {vehicleBrand === 'أخرى' ? vehicleBrandCustom : vehicleBrand || ''}
              </div>
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '63%', left: '8%', width: '18%', textAlign: 'left', direction: 'ltr'}}>
                {vehicleWeight || ''}
              </div>
              
              {/* Row 7: حمولة المركبة (يمين) | سنة الصنع (يسار) */}
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '70%', right: '12%', width: '18%', textAlign: 'left', direction: 'ltr'}}>
                {vehicleLoad || ''}
              </div>
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '70%', left: '8%', width: '18%', textAlign: 'left', direction: 'ltr'}}>
                {vehicleManufactureYear || ''}
              </div>
              
              {/* Row 8: الرقم التسلسلي (يمين) | تاريخ الإنتهاء (يسار) */}
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '77%', right: '12%', width: '18%', textAlign: 'left', direction: 'ltr'}}>
                {vehicleSerialNumber || ''}
              </div>
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '77%', left: '8%', width: '18%', textAlign: 'left', direction: 'ltr'}}>
                {(() => {
                  const today = new Date();
              ...
              <div className="absolute text-[9px] md:text-[12px] font-bold text-black" style={{top: '84%', right: '12%', width: '35%', textAlign: 'left', direction: 'ltr'}}>
                {vehicleColor || ''}
              </div>
            </div>
          </div>
