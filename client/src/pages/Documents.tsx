            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                <span className="absolute top-[46%] left-[50%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px'}}>تاريخ الميلاد</span>
                  ...
                  <span className="absolute top-[38%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', right: isMobile ? 'auto' : '38%', left: isMobile ? '51%' : 'auto'}}>Sex/الجنس</span>
                  <span className="absolute top-[42%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', right: isMobile ? 'auto' : '38%', left: isMobile ? '53%' : 'auto'}}>{gender === 'ذكر' ? 'M' : gender === 'أنثى' ? 'F' : ''}</span>
                  <span className="absolute top-[42%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', right: isMobile ? 'auto' : '34%', left: isMobile ? '58%' : 'auto'}}>{gender}</span>
                  ...
                  {/* Hijri Date of Birth */}
                  <span className="absolute top-[50%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'rtl', fontSize: isMobile ? '1.5%' : '9px', right: isMobile ? 'auto' : '38%', left: isMobile ? '48%' : 'auto'}}>
                    {calendarType === 'gregorian' && dateOfBirth 
                      ? (() => {
                  ...
                  <span className="absolute top-[54%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', right: isMobile ? 'auto' : '38%', left: isMobile ? '51%' : 'auto'}}>تاريخ الإصدار</span>
                  <span className="absolute top-[58%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'rtl', fontSize: isMobile ? '1.5%' : '9px', right: isMobile ? 'auto' : '38%', left: isMobile ? '51%' : 'auto'}}>
                    {(() => {
                      const today = new Date();
                  ...
                  <span className="absolute top-[62%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', right: isMobile ? 'auto' : '38%', left: isMobile ? '51%' : 'auto'}}>تاريخ الانتهاء</span>
                  <span className="absolute top-[66%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'rtl', fontSize: isMobile ? '1.5%' : '9px', right: isMobile ? 'auto' : '38%', left: isMobile ? '51%' : 'auto'}}>
                    {(() => {
                      const today = new Date();
