...
{/* Personal Photo Section */}
        ...
        <div className={`mb-8 ${showPassport ? '' : 'hidden'}`}>
          ...
          <div className="flex justify-center">
                ...
                <span className="absolute top-[46%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '6px' : '9px', left: isMobile ? '48%' : '50%'}}>تاريخ الميلاد</span>
                  ...
                  <span className="absolute top-[54%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '6px' : '9px', left: isMobile ? '47%' : '50%'}}>تاريخ الإصدار</span>
