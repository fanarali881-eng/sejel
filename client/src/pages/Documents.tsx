            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                {passportImage ? (
                  ...
                  <span className="absolute top-[42%] left-[30%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: '1.2%'}}>SAUDI ARABIA السعودية</span>
                ...
                <span className="absolute top-[46%] left-[48%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: '1.5%'}}>تاريخ الميلاد</span>
                  ...
                  <span className="absolute top-[38%] left-[50%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: '1.5%'}}>Sex/الجنس</span>
                  <span className="absolute top-[42%] left-[50%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: '1.5%'}}>{gender === 'ذكر' ? 'M' : gender === 'أنثى' ? 'F' : ''}</span>
                  <span className="absolute top-[42%] left-[54%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: '1.5%'}}>{gender}</span>
