            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                <span className="absolute top-[46%] left-[48%] text-[#0D5C3D] text-xs" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr'}}>تاريخ الميلاد</span>
                  ...
                  {/* MRZ Lines */}
                  <div className="absolute top-[86%] left-[2%] right-[2%] text-black text-base font-bold" style={{fontFamily: 'OCR-B, Courier New, monospace', letterSpacing: '0.2em', direction: 'ltr'}}>
                  ...
                  <div className="absolute top-[92%] left-[2%] right-[2%] text-black text-base font-bold" style={{fontFamily: 'OCR-B, Courier New, monospace', letterSpacing: '0.2em', direction: 'ltr'}}>
                    {passportNumber}&lt;&lt;0SAU{(() => {
