            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                {passportImage ? (
                  ...
                  <span className="absolute top-[42%] left-[30%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: '0.7%', letterSpacing: '-0.05em'}}>SAUDI ARABIA السعودية</span>
