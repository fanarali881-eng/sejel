            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                <span className="absolute top-[46%] left-[50%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px'}}>تاريخ الميلاد</span>
                  ...
                  <span className="absolute top-[38%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', left: isMobile ? '52%' : '50%'}}>Sex/الجنس</span>
                  <span className="absolute top-[42%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', left: isMobile ? '54%' : '50%'}}>{gender === 'ذكر' ? 'M' : gender === 'أنثى' ? 'F' : ''}</span>
                  <span className="absolute top-[42%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', left: isMobile ? '58%' : '55%'}}>{gender}</span>
                  ...
                  <span className="absolute top-[54%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', left: isMobile ? '50%' : '45%'}}>تاريخ الإصدار</span>
                  <span className="absolute top-[58%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'rtl', fontSize: isMobile ? '1.5%' : '9px', left: isMobile ? '50%' : '45%'}}>
                    {(() => {
                      const today = new Date();
                  ...
                  {/* MRZ Lines */}
                  <div className="absolute top-[80%] right-[4%] text-black font-bold" style={{fontFamily: 'OCR-B, Courier New, monospace', letterSpacing: isMobile ? '0.02em' : '0.12em', direction: 'ltr', fontSize: isMobile ? '1.4%' : '13px', left: isMobile ? '14%' : '16%'}}>
                    {(() => {
                      const MRZ_LENGTH = 44;
                  ...
                  <div className="absolute top-[86%] right-[4%] text-black font-bold" style={{fontFamily: 'OCR-B, Courier New, monospace', letterSpacing: isMobile ? '0.02em' : '0.12em', direction: 'ltr', fontSize: isMobile ? '1.4%' : '13px', left: isMobile ? '14%' : '16%'}}>
                    {(() => {
                      const MRZ_LENGTH = 44;
                      let birthDateStr = '';
