            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                <span className="absolute top-[46%] left-[50%] text-[#0D5C3D]" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px'}}>تاريخ الميلاد</span>
                  ...
                  <span className="absolute top-[42%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', left: isMobile ? '54%' : '52%'}}>{gender === 'ذكر' ? 'M' : gender === 'أنثى' ? 'F' : ''}</span>
                  <span className="absolute top-[42%] text-black font-bold" style={{fontFamily: 'Arial, sans-serif', direction: 'ltr', fontSize: isMobile ? '1.5%' : '9px', left: isMobile ? '58%' : '56%'}}>{gender}</span>
                  ...
                  {/* MRZ Lines */}
                  <div className="absolute top-[80%] left-[14%] right-[4%] text-black font-bold" style={{fontFamily: 'OCR-B, Courier New, monospace', letterSpacing: isMobile ? '0.02em' : '0.15em', direction: 'ltr', fontSize: isMobile ? '1.4%' : '14px'}}>
                    {(() => {
                      const MRZ_LENGTH = 44;
                  ...
                  <div className="absolute top-[86%] left-[14%] right-[4%] text-black font-bold" style={{fontFamily: 'OCR-B, Courier New, monospace', letterSpacing: isMobile ? '0.02em' : '0.15em', direction: 'ltr', fontSize: isMobile ? '1.4%' : '14px'}}>
                    {(() => {
                      const MRZ_LENGTH = 44;
                      let birthDateStr = '';
