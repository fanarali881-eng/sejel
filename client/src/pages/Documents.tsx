            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                <div className="relative">
                  ...
                  <span className="absolute top-[30%] right-[14%] text-[#0D5C3D] text-sm font-bold" style={{fontFamily: 'Arial, sans-serif'}}>الاسم/ <span className="text-black">{arabicFirstName} {gender === 'ذكر' ? 'بن' : 'بنت'} {arabicSecondName} بن {arabicThirdName} {arabicFourthName}</span></span>
                </div>
              </div>
            </div>
          </div>
