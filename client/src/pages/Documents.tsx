            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center">
                ...
                <div className="relative">
                  ...
                  <span className="absolute top-[38%] left-[30%] text-[#0D5C3D] text-sm font-bold" style={{fontFamily: 'Arial, sans-serif'}}>Nationality/الجنسية</span>
                  <span className="absolute top-[41%] left-[30%] text-black text-sm font-bold" style={{fontFamily: 'Arial, sans-serif'}}>SAUDI ARABIA السعودية</span>
                </div>
              </div>
            </div>
          </div>
