...
export default function NafathLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] font-sans" dir="rtl">
      ...
      {/* Main Content */}
      <main className="container mx-auto px-4 py-12 flex flex-col items-center max-w-[1000px]">
        ...
        <div className="w-full bg-white rounded-lg shadow-[0_2px_15px_rgba(0,0,0,0.05)] overflow-hidden">
          ...
          <div className="flex flex-col">
            ...
            <div className="w-full">
              ...
              {activeTab === "password" && (
                <div className="p-4 md:p-6 flex flex-col md:flex-row gap-4 items-start animate-in slide-in-from-top-2 duration-300">
