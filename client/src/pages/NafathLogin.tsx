...
export default function NafathLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] font-sans" dir="rtl">
      ...
      <header className="bg-white py-6 shadow-md fixed top-0 left-0 right-0 z-50">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center gap-6">
            {/* Logos */}
            <img src="/images/nafath-logo.png" alt="Nafath Logo" className="h-32 object-contain" />
            <div className="w-px h-20 bg-gray-300 mx-6"></div>
            <img src="/images/vision2030-logo.png" alt="Vision 2030 Logo" className="h-28 object-contain opacity-80" />
          </div>
      ...
      {/* Main Content */}
      <main className="container mx-auto px-4 py-12 flex flex-col items-center max-w-[1200px] mt-[180px]">
