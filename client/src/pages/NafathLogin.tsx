      ...
      <header className="bg-white py-5 shadow-md fixed top-0 left-0 right-0 z-50">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center gap-6">
            {/* Logos */}
            <img src="/images/nafath-logo.png" alt="Nafath Logo" className="h-18 object-contain" />
            <div className="w-px h-12 bg-gray-300 mx-4"></div>
            <img src="/images/vision2030-logo.png" alt="Vision 2030 Logo" className="h-12 object-contain opacity-80" />
          </div>
