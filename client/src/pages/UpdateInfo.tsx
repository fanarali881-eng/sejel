          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <Card className="border-none shadow-sm bg-white">
                <CardContent className="p-2 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-y-4 md:gap-y-6 gap-x-12">
                  <div>
                    ...
                    <Input 
                      ...
                      className={`font-bold text-sm md:text-base text-gray-800 h-12 md:h-10 placeholder:font-normal placeholder:text-gray-400 ${validationErrors.arabicName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                    />
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      className={`font-bold text-sm md:text-base text-gray-800 text-left h-12 md:h-10 placeholder:font-normal placeholder:text-gray-400 ${validationErrors.englishName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                      dir="ltr" 
                    />
                  ...
                  <div>
                    ...
                    <Select value={nationality} onValueChange={(val) => {
                      ...
                      <SelectTrigger className={`font-bold text-sm md:text-base text-gray-800 w-full text-right h-12 md:h-10 ${validationErrors.nationality ? 'border-red-500 focus:ring-red-500' : ''}`}>
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      placeholder="سعودي" 
                      className={`font-bold text-sm md:text-base text-gray-800 h-12 md:h-10 placeholder:font-normal placeholder:text-gray-400 ${validationErrors.ownerType ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                    />
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      className={`font-bold text-sm md:text-base text-gray-800 h-12 md:h-10 placeholder:font-normal placeholder:text-gray-400 ${nationalIdError || validationErrors.nationalId ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                    />
                  ...
                  <div>
                    ...
                    <Select value={gender} onValueChange={(val) => {
                      ...
                      <SelectTrigger className={`font-bold text-sm md:text-base text-gray-800 w-full text-right h-12 md:h-10 ${validationErrors.gender ? 'border-red-500 focus:ring-red-500' : ''}`}>
